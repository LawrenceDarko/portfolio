...
const ProjectsTwo = () => {
    ...
    return (
        <div id="section Works" className="flex flex-col justify-center gap-8 px-4 py-8 md:py-12 md:gap-28 md:px-10 lg:px-16 xl:px-36">
            ...
            <ProjectTwoItem image='fintrack.jpg' title="Slack Clone" description={descriptions.desc6} projectLink="https://fab-track.vercel.app/" techStack={['Next.js', 'Tailwindcss', 'Node', 'Chart.js', 'Express.js']}/>
            ...
            <ProjectTwoItem showRight image="paymentlink.png" title="Payment Pages" description={descriptions.desc4} projectLink="https://payment-pages.theteller.net/pay/EK88QPNn" githublink="" techStack={['React', 'Next.Js', 'Tailwind CSS', 'Vercel']}/>
