        ...
        <div className='w-full h-auto md:p-5 md:px-8 lg:px-10 xl:px-28 2xl:px-36'>
            <div className="flex flex-col items-center justify-between gap-4 lg:flex-row md:gap-8 lg:gap-10 xl:gap-12 2xl:gap-20">
                <div className="p-4 pt-20 md:p-0 md:w-[500px]">
                    ...
                    <p className="text-sm md:text-base text-[#92929A] mt-6 leading-6 md:pr-12">These represent the powerful tools and technologies that drive my software engineering journey, empowering me to create efficient and scalable solutions while staying at the forefront of emerging fields in the industry.</p>
                </div>
